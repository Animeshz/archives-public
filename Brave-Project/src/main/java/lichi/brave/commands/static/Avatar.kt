...
class Avatar(jda: JDA): Command(jda, mapOf<String, Any>("name" to "avatar", "description" to "A simple command for ", "userPermissions" to EnumSet.of(Permission.MESSAGE_WRITE), "throttling" to mapOf("usages" to 2, "time" to 15)))
{
